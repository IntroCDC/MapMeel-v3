...
public class CommandResetALL implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        for (int key : Bot.getBots().keySet()) {
        ...
        Hopper hopper = (Hopper) Bukkit.getWorld("world").getBlockAt(5036, 28, 4874).getState();
        ...
        ItemStack keyEG2 = new ItemStack(Material.PAPER, 2);
        ItemMeta keyEG2Meta = keyEG2.getItemMeta();
        ...
        ItemStack passEG2p1 = new ItemStack(Material.WRITTEN_BOOK);
        BookMeta passEG2p1Meta = (BookMeta) passEG2p1.getItemMeta();
        ...
        ItemStack passEG2p2 = new ItemStack(Material.WRITTEN_BOOK);
        BookMeta passEG2p2Meta = (BookMeta) passEG2p2.getItemMeta();
        ...
        ItemStack passEG2p3 = new ItemStack(Material.WRITTEN_BOOK);
        BookMeta passEG2p3Meta = (BookMeta) passEG2p3.getItemMeta();
        ...
        ItemStack passEG2p4 = new ItemStack(Material.WRITTEN_BOOK);
        BookMeta passEG2p4Meta = (BookMeta) passEG2p4.getItemMeta();
        ...
        Hopper hopper2 = (Hopper) Bukkit.getWorld("world_the_end").getBlockAt(5809, 49, 4911).getState();
        ...
        ItemStack keyEG4 = new ItemStack(Material.PAPER, 2);
        ItemMeta keyEG4Meta = keyEG4.getItemMeta();
        keyEG4Meta.setDisplayName("#TheBasesDarknessBrightness");
        keyEG4.setItemMeta(keyEG4Meta);
        hopper2.getInventory().setItem(4, keyEG4);

        ArrayList<Chest> papers = new ArrayList<>();
        ArrayList<Chest> xps = new ArrayList<>();
